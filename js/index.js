...
function result() {
    ...
    document.getElementById('result').innerHTML = "Результаты поиска: " + `<span style='color: red; font-size: 21px'>${count}</span>`
}
...
function thanks() {
    swal({
        ...
        text: "Проект распространяется бесплатно и с открытым исходным кодом. Если Вы хотите поддержать проект и сделать небольшое пожертвование на его развитие, то это можно сделать через систему \"Сбербанк онлайн\" по телефону 8-914-154-51-89",
        icon: "success",
        button: "Ok!",
    });
}